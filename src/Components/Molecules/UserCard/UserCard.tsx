...
const UserCard = ({
  ...
  const handleDelete = () => {
    ...
    if (confirmation) {
      deleteMutation.mutate(userId); // Trigger the deletion
    }
  };
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-end">
        <Button
          className={`button-base px-4 py-1 mr-4 ${lightTheme ? "blue-button" : "blue-button-dark"}`}
          label="Edit"
          onClick={handleEdit}
        />
        <Button
          className={`button-base px-3 py-2 mr-3 ${lightTheme ? "red-button" : "red-button-dark"}`}
          label="Delete"
